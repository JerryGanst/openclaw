...
- Completion synthesis for orchestrator sessions is scoped to the active parent run, child results from prior turns are excluded from the current announce payload.
